...
if len(route) > 65:
    obstacle_manager.spawn_on_route(route_index=65, speed_mps=3.0, lateral_offset=0.0)

# Second moving obstacle farther ahead. Give it a small lateral offset to test side prediction.
if len(route) > 140:
    obstacle_manager.spawn_on_route(route_index=140, speed_mps=2.0, lateral_offset=0.35)
